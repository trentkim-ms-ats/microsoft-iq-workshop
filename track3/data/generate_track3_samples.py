#!/usr/bin/env python3
"""Generate deterministic Track3 scenario inputs from Track1/Track2 artifacts."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Generate Track3 scenario datasets from Track1/Track2 assets.")
    parser.add_argument(
        "--track1-root",
        type=Path,
    ...
    parser.add_argument(
        ...
        help="Output directory where generated files are saved.",
    )
    parser.add_argument(
        "--pretty",
        action="store_true",
