...
>
> **2026-07-29 과정 변경:** 아래 P1 위치·건수와 검증 SQL은 강사 설명 및 회귀
> 확인용으로만 보존합니다. 참가자 미션 2/5에서 탐지·수정하거나 제출·채점하지 않습니다.
...
### 미션 2 — 설명 전용
강사는 아래 유형이 분석에 미치는 영향을 설명할 수 있으나 참가자에게 위치·건수를
찾게 하지 않습니다.
...
5. 날짜/타임스탬프 포맷 혼재
→ 참가자 DoD나 Track2 시작 조건으로 사용하지 않습니다.
...
### 강사/회귀 전용 구조 무결성 확인 (참가자 미션 5 아님)
